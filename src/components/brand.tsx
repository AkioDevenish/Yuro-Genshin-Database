export function BrandMark({ size = 40 }: { size?: number }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="iica-mark" x1="8" y1="4" x2="40" y2="44" gradientUnits="userSpaceOnUse">
          <stop stopColor="#6EE7B7" />
          <stop offset="0.55" stopColor="#10B981" />
          <stop offset="1" stopColor="#047857" />
        </linearGradient>
      </defs>
      <rect x="2" y="2" width="44" height="44" rx="13" fill="url(#iica-mark)" opacity="0.16" />
      <rect
        x="2.75"
        y="2.75"
        width="42.5"
